...
if [[ $cpu_cores -eq 4 ]]; then
    ...
    docker run -d --name urnetwork --restart=always --memory=100mb --platform linux/amd64 -e USER_AUTH="yoji.nguyen9414@gmail.com" -e PASSWORD="Anhtuan@9414" tuanna9414/urnetwork:latest
fi
